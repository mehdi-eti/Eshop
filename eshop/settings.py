...
SECRET_KEY = 'django-insecure-s4jhmj+e$@o5d@u6i9yfcn0qtk_0o#0aj9#m=9f79-%7!=v59t'
...
INSTALLED_APPS = [
    ...
    'eshop_account.apps.EshopAccountConfig',
    'eshop_products.apps.EshopProductsConfig',
    'eshop_tags.apps.EshopTagsConfig',
    'eshop_products_categories.apps.EshopProductsCategoriesConfig',
    'esho_slider.apps.EshoSliderConfig',
    'eshop_contactUs.apps.EshopContactusConfig',
